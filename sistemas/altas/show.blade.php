...
<div class="max-w-4xl mx-auto mt-10">
    ...
    <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
        ...
        <div class="flex flex-wrap gap-4 mt-6">
            <a href="{{ route('sistemas.altas.index') }}" class="inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded transition">
                Volver
            </a>
            <a href="{{ route('sistemas.altas.descargarPdf', $alta->id) }}" class="inline-block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded transition" target="_blank">
                Descargar PDF
            </a>
        </div>
    </div>
